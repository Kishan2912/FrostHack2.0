  ...
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="https://www.facebook.com/saransh.jain.921677" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917300067222" target="_blank">
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Overall Head</p>
        <a rel="noreferrer" href="https://www.facebook.com/kartik.kathuria.146" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917982453395" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Overall Head</p>
        <a rel="noreferrer" href="https://www.facebook.com/subhash.suman.186" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917703813759" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Overall Head</p>
        <a rel="noreferrer" href="https://www.facebook.com/vyom.goel.12" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919816790032" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="https://www.facebook.com/vgzelda123" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917009300207" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="https://www.facebook.com/vsvipul555" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919418322955" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="https://www.facebook.com/astromanahas" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+918628963924" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="https://www.facebook.com/profile.php?id=100011143120838" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919877757063" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/shobhit.rajput.391" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+918126588271" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://m.facebook.com/priyam.seth.336" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919811417932" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/vineet.ahuja.378" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919911473244" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://m.facebook.com/profile.php?id=100014538347418&ref=content_filter" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917987590764" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/shubham.saurav.980967" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+919304902560" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/priyanshu.shubham3" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+918340437870" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/profile.php?id=100006780016974" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+918130476897" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Technical</p>
        <a rel="noreferrer" href="https://www.facebook.com/divyasheel.kumar/" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+918437151118" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/kharkwalpranshu" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
        <a rel="noreferrer" href="tel:+917876219654" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <p className="changecolor">Branding</p>
        <a rel="noreferrer" href="https://www.facebook.com/deepali.s11/" target="_blank">
          <i className="fab fa-facebook fa-lg" />
        </a>
      ...
      <div className="col-lg-3 col-md-6 centered">
        ...
        <a rel="noreferrer" href="tel:+917042728328" target="_blank">
          <i className="fas fa-phone fa-lg" />
        </a>
      </div>
      {/* /team-member */}
